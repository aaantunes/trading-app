...
public class IexQuote {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("symbol", symbol).append("companyName", companyName).append("primaryExchange", primaryExchange).append("sector", sector).append("calculationPrice", calculationPrice).append("open", open).append("openTime", openTime).append("close", close).append("closeTime", closeTime).append("high", high).append("low", low).append("latestPrice", latestPrice).append("latestSource", latestSource).append("latestTime", latestTime).append("latestUpdate", latestUpdate).append("latestVolume", latestVolume).append("iexRealtimePrice", iexRealtimePrice).append("iexRealtimeSize", iexRealtimeSize).append("iexLastUpdated", iexLastUpdated).append("delayedPrice", delayedPrice).append("delayedPriceTime", delayedPriceTime).append("extendedPrice", extendedPrice).append("extendedChange", extendedChange).append("extendedChangePercent", extendedChangePercent).append("extendedPriceTime", extendedPriceTime).append("previousClose", previousClose).append("change", change).append("changePercent", changePercent).append("iexMarketPercent", iexMarketPercent).append("iexVolume", iexVolume).append("avgTotalVolume", avgTotalVolume).append("iexBidPrice", iexBidPrice).append("iexBidSize", iexBidSize).append("iexAskPrice", iexAskPrice).append("iexAskSize", iexAskSize).append("marketCap", marketCap).append("peRatio", peRatio).append("week52High", week52High).append("week52Low", week52Low).append("ytdChange", ytdChange).toString();
    }
